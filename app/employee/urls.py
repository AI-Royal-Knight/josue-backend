...
urlpatterns = [
    ...
    path('my-folders/subfolder/<uuid:assignment_id>/tasks/', SubfolderTasksView.as_view(), name='subfolder-tasks'),
    path('my-folders/subfolder/<uuid:assignment_id>/tasks/submit/', SubmitSubfolderTaskView.as_view(), name='submit-subfolder-task'),
    ...
    path('operations/<str:op_type>/<uuid:op_id>/complete/', OperationCompleteView.as_view(), name='operation-complete'),
