...
urlpatterns = [
    ...
    path('supplier-invoices/', views.ProcurementSupplierInvoiceListView.as_view(), name='procurement-supplier-invoice-list'),
    path('supplier-invoices/<uuid:pk>/', views.ProcurementSupplierInvoiceDetailView.as_view(), name='procurement-supplier-invoice-detail'),
